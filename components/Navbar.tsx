...
=======
            <div className="absolute top-full left-0 mt-2 w-56 bg-white border border-gray-100 shadow-xl rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 flex flex-col translate-y-2 group-hover:translate-y-0 cursor-default">
      <Link href="#" className="px-4 py-3 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors">Layanan SUOP</Link>
      <div className="group/eslo relative">
        ...
        {/* Boomer friendly dropdown container (Scaled down) */}
...
<<<<<<< Updated upstream
    < div
  className = {`fixed inset-0 bg-black/60 backdrop-blur-sm z-40 transition-opacity duration-300 lg:hidden ${isMobileMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'
    }`
}
=======
      <div
...
<<<<<<< Updated upstream
<div
  className={`fixed top-0 right-0 h-full w-[85%] max-w-[320px] bg-white z-[501] shadow-2xl transition-transform duration-300 transform lg:hidden overflow-y-auto flex flex-col ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
    }`}
=======
      <div
        className={`fixed top-0 right-0 h-full w-[280px] sm:w-[320px] bg-white z-50 shadow-2xl transition-transform duration-300 transform lg:hidden overflow-y-auto ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
>>>>>>> Stashed changes
>
...
=======
      ...
      <div className="pl-4 py-2 space-y-1 bg-gray-50/50 rounded-xl mt-1">
        <Link href="#" className="block py-2 px-4 text-sm text-gray-600 hover:text-blue-600" onClick={() => setIsMobileMenuOpen(false)}>Layanan SUOP</Link>
