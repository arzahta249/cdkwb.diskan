...
export default function CreateArtikelInstagramPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Dummy isi artikel agar tidak ditolak API
          ...
          <div className="p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-pink-500/20 mb-6">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-pink-100/80 leading-relaxed">
                Anda hanya perlu memasukkan link Instagram. Judul di bawah ini digunakan untuk penamaan di tabel dashboard. Konten foto dan teks aslinya akan otomatis ditarik saat dibaca oleh pengunjung.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2 md:col-span-2">
              ...
              <input 
                ...
                placeholder="Contoh: Info Konservasi Baru..."
              />
            </div>
          </div>
